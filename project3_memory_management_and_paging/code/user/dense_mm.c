...
/*
 * step 6:evaluating performance of your module
 * the timeval struct:
 * {
 ...
 * }
 */
static struct timeval start_mmp,end_mmp,start_compute,end_compute;
...
int main (int argc, char* argv[])
{
    ...
    printf("Time consuming for mmap(microseconds):%ld\n",((end_mmp.tv_sec*1000000+end_mmp.tv_usec)-(start_mmp.tv_sec*1000000+start_mmp.tv_usec)));
    printf("Time point of finishing computing (microseconds):%ld\n",((end_compute.tv_sec*1000000+end_compute.tv_usec)-(start_compute.tv_sec*1000000+start_compute.tv_usec)));
